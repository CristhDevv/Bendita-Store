  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-md glass border border-gold-500/20 rounded-2xl p-6"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            >
              {form.is_default && (
                <svg viewBox="0 0 12 9" className="w-3 h-3 text-navy-950" fill="currentColor">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex items-center justify-center gap-2 w-full py-3 bg-gold-500 hover:bg-gold-400 text-navy-950 rounded-xl font-body font-semibold text-sm transition-colors disabled:opacity-60"
          >
