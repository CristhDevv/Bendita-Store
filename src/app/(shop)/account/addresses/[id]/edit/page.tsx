...
import { getUserAddresses, upsertAddress } from "@/lib/supabase/account";
...
export default function EditAddressPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await upsertAddress(user.id, { ...form, id });
    ...
    >
      ...
      <div className="bg-white border border-border rounded-2xl p-6 shadow-sm max-w-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="font-display text-2xl text-charcoal">Editar Dirección</h1>
        </div>
