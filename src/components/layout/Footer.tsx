      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <p className="font-display italic text-crystal/80 text-lg">
              "Tu esencia, nuestra pasión"
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-crystal hover:text-gold hover:border-gold-500/50 transition-all">
                {/* Instagram SVG */}
              ...
              {["Inicio", "Catálogo", "Marcas", "Ofertas", "Mi Cuenta", "Wishlist"].map((item) => (
                <li key={item}>
                  <Link
                    ...
                    className="text-crystal/70 hover:text-gold transition-colors text-sm font-body"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <ul className="space-y-4 text-center md:text-left text-sm font-body text-crystal/70">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-body text-crystal/50">
